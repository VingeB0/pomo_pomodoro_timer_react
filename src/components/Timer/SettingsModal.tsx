...
export const SettingsModal = ({
  ...
  return (
    <Modal
      ...
      onClose={setOpen}
      sx={{
        bgcolor: mode === THEME_MODE.LIGHT ? modalOverlayColors[THEME_MODE.LIGHT] : modalOverlayColors[THEME_MODE.DARK],
      }}
    >
      <StyledModal bgcolor={currentTheme[colorByModeModal[TYPE_OF_COLORS.PRIMARY]]}>
        <Box display="flex" justifyContent="space-between" alignItems="center" mb="1.625rem">
          <Text variant="headingH1" color={currentTheme[colorByModeModal[TYPE_OF_COLORS.SECONDARY]]}>
            Settings
          </Text>
          <IconButton
            iconSize=".75rem"
        ...
        <Box>
          ...
          <Box display="flex" alignItems="center" justifyContent="space-between" py="1.375rem">
            ...
            <NumberTextField
              time={time[THEME_STATE.SHORT_BREAK]}
              getValue={(value: number) =>
                setTime((prev: timeType) => ({
                  ...prev,
          ...
          <Box display="flex" alignItems="center" justifyContent="space-between" py="1.375rem">
            ...
            <NumberTextField
              time={time[THEME_STATE.LONG_BREAK]}
              getValue={(value: number) =>
                setTime((prev: timeType) => ({
                  ...prev,
